...
SELECT item_purchased, ROUND(CAST(AVG(review_rating) AS DECIMAL(10, 2)), 2) AS Average_Product_Rating FROM customer GROUP BY item_purchased ORDER BY AVG(review_rating) DESC LIMIT 5;
select * from customer;

-- Q4. Compare the average Purchase Amounts between Standard and Express Shipping.
SELECT shipping_type,ROUND(AVG(review_rating), 2) 
FROM customer
